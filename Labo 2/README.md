...
└── catalog/                        # Catalog microservice (Spring Boot + MongoDB) — see catalog/README.md
    ├── Dockerfile
    ├── pom.xml
...
A standalone Products/Categories catalog service (Spring Boot + MongoDB), independent from the main .NET backend's relational data. See [`catalog/README.md`](./catalog/README.md) for endpoints and setup. Bring it up with:
