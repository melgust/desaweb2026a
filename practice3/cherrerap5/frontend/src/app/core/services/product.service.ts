...
export class ProductService {
  ...
  getAllProducts(): Observable<Product[]> {
    return this.getProducts(undefined, 'name', 'asc', 1, 100).pipe(
      expand(page => page.page < page.totalPages ? this.getProducts(undefined, 'name', 'asc', page.page + 1, 100) : EMPTY),
      reduce((items: Product[], page) => [...items, ...page.items], [])
    );
  }
